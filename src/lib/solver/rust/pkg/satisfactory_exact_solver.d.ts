 ...
 */
export function solve_exact(input_json: string, on_progress?: Function | null): string;
...
export interface InitOutput {
    ...
    readonly solve_exact: (a: number, b: number, c: number) => [number, number, number, number];
