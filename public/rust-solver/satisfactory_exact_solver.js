/* @ts-self-types="./satisfactory_exact_solver.d.ts" */
 ...
 * @returns {string}
 */
export function solve_exact(input_json, on_progress) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(input_json, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ret = wasm.solve_exact(ptr0, len0, isLikeNone(on_progress) ? 0 : addToExternrefTable0(on_progress));
        var ptr2 = ret[0];
        var len2 = ret[1];
        if (ret[3]) {
            ptr2 = 0; len2 = 0;
 ...
 * @returns {string}
 */
export function solver_version() {
    let deferred1_0;
    let deferred1_1;
    try {
        const ret = wasm.solver_version();
        deferred1_0 = ret[0];
        deferred1_1 = ret[1];
...
function __wbg_get_imports() {
    ...
    return {
        __proto__: null,
        "./satisfactory_exact_solver_bg.js": import0,
    };
}
